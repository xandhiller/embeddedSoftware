...
#define FILTERED_DATA_X	          AccelDataBuffer.FilteredAccelData.axes.x
#define FILTERED_DATA_Y           AccelDataBuffer.FilteredAccelData.axes.y
#define FILTERED_DATA_Z           AccelDataBuffer.FilteredAccelData.axes.z
...
/*! @brief Apply median filter to the x values, y values and z values, then place into filtered buffer space.
 *
 */

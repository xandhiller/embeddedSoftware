...
struct _AccelDataBuffer
{
  TAccelData Buffer[3];
  TAccelData NewAccelData;
  TAccelData OldAccelData;
  uint8_t Index;
} AccelDataBuffer;

#define ACCEL_BUFFER_DATA_INPUT   AccelDataBuffer.Buffer[AccelDataBuffer.Index].bytes
#define NEW_DATA_X                AccelDataBuffer.NewAccelData.axes.x
#define NEW_DATA_Y                AccelDataBuffer.NewAccelData.axes.y
#define NEW_DATA_Z                AccelDataBuffer.NewAccelData.axes.z
#define OLD_DATA_X                AccelDataBuffer.OldAccelData.axes.x
#define OLD_DATA_Y                AccelDataBuffer.OldAccelData.axes.y
#define OLD_DATA_Z                AccelDataBuffer.OldAccelData.axes.z
